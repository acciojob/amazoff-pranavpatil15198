...
public class OrderController {
    ...
    public ResponseEntity<String> addOrderPartnerPair(@RequestParam String orderId, @RequestParam String partnerId){
        orderService.setOrderDeliveryPartner(orderId, partnerId);
    ...
    public ResponseEntity<Integer> getOrderCountByPartnerId(@PathVariable String partnerId){
        ...
        Integer orderCount = orderService.getOrdersByPartner(partnerId);
    ...
    public ResponseEntity<Integer> getOrdersLeftAfterGivenTimeByPartnerId(@PathVariable String time, @PathVariable String partnerId){
        ...
        Integer countOfOrders = orderService.orderLeftAfterGivenTime(time, partnerId);
    ...
    public ResponseEntity<String> getLastDeliveryTimeByPartnerId(@PathVariable String partnerId){
        String time = orderService.getFinalDeliveryTime(partnerId);
